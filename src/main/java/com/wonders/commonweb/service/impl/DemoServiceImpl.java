...
public class DemoServiceImpl implements IDemoService {
    ...
    @Override
    public ResultList getAllTableName(Table table) {
        /**
         * 获取页面传入的行数和页数
         *      使用分页插件进行分页
         */
//        PageHelper.offsetPage(Integer.valueOf(table.getOffset()), Integer.valueOf(table.getLimit()));
//        List<Table> allTableName=demoDao.selectAllTableName(table);
//        PageInfo<Table> pojoPageInfo = new PageInfo<>(allTableName);
